#!/usr/bin/env python3
"""Evaluate AudioToolAgent (open configuration) on MMAR."""
...
def _prepare_mmar(sample: dict, work_dir: str) -> PreparedSample:  # noqa: ARG001
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run MMAR benchmark with open configuration")
